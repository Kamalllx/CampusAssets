    ...
    <div className="space-y-8 max-w-full">
      ...
      <div className="grid xl:grid-cols-4 gap-8">
        ...
        <div className="xl:col-span-3">
          <Card className="flex flex-col rounded-3xl border-0 shadow-2xl bg-white/90 backdrop-blur-sm h-[600px]">
            ...
            <CardContent className="flex-1 flex flex-col p-0 overflow-hidden">
              <ScrollArea className="flex-1 p-6">
                <div className="space-y-6 pr-4">
                  {messages.map((message) => (
                    ...
                    >
                      <div
                        className={`max-w-[80%] rounded-3xl p-4 shadow-lg break-words ${
                          message.type === "user"
              ...
              <div className="p-6 bg-gray-50 rounded-b-3xl flex-shrink-0">
                <div className="flex space-x-4">
                  <Input
                    placeholder={
                      activeTab === "chat"
                  ...
                  <Button
                    ...
                    size="icon"
                    className="h-12 w-12 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex-shrink-0"
                  >
          ...
          <Card className="rounded-3xl border-0 shadow-xl bg-gradient-to-br from-purple-50 to-pink-50">
            ...
            <CardContent className="space-y-3">
              {exampleQueries[activeTab].map((query, index) => (
                ...
                >
                  <p className="text-sm text-gray-700 font-medium break-words">{query}</p>
                </div>
              ))}
            </CardContent>
          </Card>
